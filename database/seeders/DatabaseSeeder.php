...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        //Llamada Seeder del catálogo
        self::seedProductos();
        $this->command->info('Tabla productos inicializada con datos!');

        //Llamada Seeder de los usuarios
        self::seedUsers();
    ...
    function seedUsers(){
        ...
        foreach ( self::$arrayUsers as $usuario) {
            $user = new User;
            $user->nombre = $usuario[0];
            $user->apellidos = $usuario[1];
            $user->email = $usuario[2];
            $user->password = bcrypt($usuario[3]);
            $user->save();
        }
    }

    private static $arrayUsers = [
        ['Ariana', 'Megas de la Fuente', 'arianaMF@gmail.com', 'justinoB'],
        ['Patricio', 'Baños Batista', 'patricioEstrella@gmail.com', 'bobesponja'],
        ['Florin', 'Zafra Montero', 'florero@gmail.com', 'jarronParaFlores'],
        ['Maria', 'Amparo Gomis', 'amparoM@gmail.com', 'AmparoM1234']
    ];
